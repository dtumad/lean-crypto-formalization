...
@[simp] lemma drop_query_eq_empty_iff_le_singleton : drop_query i t cache = ∅ ↔
  ∃ u, cache ≤ [i, t ↦ u] :=
sorry
-- begin
--   refine ⟨λ h, _, λ h, _⟩,
...
--   { obtain ⟨u, hu⟩ := h,
--     simp_rw [eq_empty_iff, is_fresh_drop_query_iff, or_iff_not_imp_left,
