...
@[simp] lemma apply_eq (i : spec.ι) (z : spec.domain i × query_log spec) : cachingₛₒ i z =
  option.rec_on (z.2.lookup i z.1) (do {u ← query i z.1, return (u, z.2.log_query i z.1 u)})
    (λ u, return (u, z.2)) := by cases z; refl
